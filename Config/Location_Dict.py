class Location_Dict:
    def __init__(self):
        ...
        "Evil Forest" : {"name" : "Evil Forest", "monsters" : ["Orc", "Hob Goblin", "Troll"], "treasure" : [], "weather" : ["Fog", "Rain", "None"], "dungeon_size" : 5, "events" : [], "image" : "Forest", "boss" : True, "bosses" : ["Vampire", "Demon"]}
        }