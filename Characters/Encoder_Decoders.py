...
class Skill_Decoder(json.JSONDecoder):
    ...
    def object_hook(self, obj):
        if 'name' in obj and 'effect' in obj and 'effect_specifics' in obj and 'power' in obj and 'targets' in obj and 'cost' in obj and "scale" in obj and 'cooldown' in obj and 'cooldown_counter' in obj and 'chance' in obj and 'condition' in obj and 'condition_specifics' in obj:
            return Skill(obj['name'], obj['effect'], obj['effect_specifics'], obj['power'], obj['targets'], obj['cost'], obj['scale'], obj['cooldown'], obj['cooldown_counter'], obj['chance'], obj['condition'], obj['condition_specifics'])
